...
【シーン設定】
生後{MONTH_AGE}ヶ月のせなっちが音楽に合わせて踊っている・ふざけているコミカルで可愛い瞬間。
月齢に合った声：{sounds}

【GPT Image 2向け：撮影スタイル】
・スタイル：Photorealistic studio photography, professional baby lifestyle photo
・カメラ：Shot with 85mm portrait lens, shallow depth of field, soft bokeh background
・照明：Soft diffused studio lighting, warm 3200K color temperature
・構図：Medium shot, subject centered, 1:1 square format
...
・白いリボンカチューシャ（細いサテンリボン）
・白いレースのロンパース（フリル付き）
・表情：満面の笑顔・楽しそう・笑いながら動いている

【背景・雰囲気】
・背景：クリーム色・アイボリー・ベージュのナチュラルスタジオ
・小物：白いふわふわのブランケット・薄いモスリンガーゼ
・全体的にナチュラル・明るく・楽しい雰囲気
"""
